...
<html>
    <head>
        <title>Lección 04 Razones Trigonométricas </title>
        <meta charset="UTF-8">
    ...
    <body style ="background-color: #FFFFFF;">
        ...
        <div class="container border p-0">
            <div class="card-header collapsed border border-light" data-toggle="collapse" data-parent="#accordion" href="#collapseCuatro"  style ="background-color: #0EB8F6;">
                <a class="card-title"><img src="../../img/icono1_leccion1.png" class="img-fluid" width="70px" alt="70px"> LECCIÓN 04: <strong>Activación de Conocimientos Previos</strong></a>
            </div>
        </div>
        <div class="container border p-0">
            <div style="width: 100%;"><div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">

                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f6a442b1fa7320d945153d7" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe>
                    ...
                    <div id="collapseContenido" class="collapse" data-parent="#accordion">
                        <div class="card-body">
                            <div style="width: 100%;"><div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                                    ...
                                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f6a4aedbc5d230d1d188488" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                                    </iframe>
                                    ...
                                    <div class="card-body">
                                        <div style="width: 100%;">
                                            <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">                                        
                                                <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f6a4f751fa7320d94515592" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">            
                                                </iframe>                                  
                                            </div> 
                                        </div>
                                    </div>
                            ...
                            <form role="form" action="" method="post">
                                <div class="form-group">
                                    <div class="form-group">
                                        <div id="loading"></div>
                                        <div id="zoliframe">
                                            <iframe src="https://titanx.cl/contenidoI/wp-admin/admin-ajax.php?action=h5p_embed&id=6" width="958" height="291" frameborder="0" allowfullscreen="allowfullscreen">                                      
                                            </iframe>
                                            <script src="https://titanx.cl/contenidoI/wp-content/plugins/h5p/h5p-php-library/js/h5p-resizer.js" charset="UTF-8"></script>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea1"> <p>1.- ¿Las razones trigonométricas se pueden utilizar en cualquier triángulo?</p></label>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea2"> <p> 2.- ¿Qué ocurre con el seno de un ángulo cuando el ángulo se acerca a 0°? ¿Qué ocurre cuando el valor del ángulo se acerca a 90°? Realice el mismo razonamiento para el coseno y la tangente.</p></label>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea3"> <p> 3.- ¿Cómo se relaciona el seno y el coseno de dos ángulos complementarios? </p></label>
                                ...
                                if ($_SESSION['userName'] != '') {
                                    echo ' <button type="submit" name ="enviar" value= "unidad1_leccion4" class="btn btn-outline-primary">Enviar</button>';
                                } else {
