...
<html>
    <head>
        <title>Lección 06 Valor esperado y varianza de una variable aleatoria </title>
        <meta charset="UTF-8">
    ...
    <body style ="background-color: #FFFFFF;">
        ...
        <div class="container border p-0">
            <div class="card-header collapsed border border-light" data-toggle="collapse" data-parent="#accordion" href="#collapseCuatro"  style ="background-color: #0EB8F6;">
                <a class="card-title"><img src="../../img/icono1_leccion1.png" class="img-fluid" width="70px" alt="70px"> LECCIÓN 06: <strong>Activación de Conocimientos Previos</strong></a>
            </div>
        </div>
        <div class="container border p-0">
            <div style="width: 100%;"><div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">

                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f7ccc59ea600f0d09d47f3b" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe>
                        ...
                        <div class="card-body">
                            <div class="panel-group" id="sub-accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div class="card-body">
                                        <div style="width: 100%;">
                                            <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                                                ...
                                                <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f7ccc8560d46a0d028ea321" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">            
                                                </iframe>
                                ...
                                <div class="card-header collapsed border border-light" data-toggle="collapse"  href="#collapseSimu1"  style ="background-color: #0EB8F6;">
                                    <a class="card-title"> <strong> Simulador </strong></a>
                                </div>
                                <div id="collapseSimu1" class="collapse" data-parent="#sub-accordion" >
                                    <div class="card-body">
                                        ...
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe scrolling="no" title="Probabilidad condicional" src="https://www.geogebra.org/material/iframe/id/rprfugma/width/1271/height/575/border/888888/sfsb/true/smb/false/stb/false/stbh/false/ai/false/asb/false/sri/false/rc/false/ld/false/sdz/false/ctl/false" width="1271px" height="575px" style="border:0px;"> </iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body"> 
                            <form role="form" action="" method="post">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <div id="zoliframe">
                                            <div class="embed-responsive embed-responsive-21by9">
                                                <iframe class="embed-responsive-item" src="https://titanx.cl/contenidoI/wp-admin/admin-ajax.php?action=h5p_embed&id=8"></iframe>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea1"> <p>1.- ¿Qué es una variable?</p></label>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea2"> <p> 2.- ¿Qué es un suceso o evento?</p></label>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea3"> <p> 3.- Si se lanzará 12 veces un dado equilibrado de seis caras, ¿cuántas veces se espera observar el valor 4?</p></label>
