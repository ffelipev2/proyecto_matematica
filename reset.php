            ...
            <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"> 
                ...
                <div class="panel panel-default" >
                    <div class="panel-heading">
                        <div class="panel-title text-center">Restablecer Contraseña</div>
                    </div>              
                    <?php
                        ...
                        <form name="form" id="form" class="form-horizontal" enctype="multipart/form-data" method="POST"  action="" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 controls">
                                    <button type="submit" name="submit" class="btn btn-primary pull-right"><i class="glyphicon glyphicon-log-in"></i> Enviar</button>                          
                                </div>
                            </div>
                        </form>     
